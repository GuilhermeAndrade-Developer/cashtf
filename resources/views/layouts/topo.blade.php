				...
				<div class="container customed">
					...
					<div class="collapse navbar-collapse" id="st-navbar-collapse">
						<ul class="nav navbar-nav navbar-right link_menu">
							<li><a href="{{route('home')}}#how_works" class="links_rodape" style="margin-right: 0px; font-weight: bold;">COMO FUNCIONA</a></li>
							...
							<li><a href="{{route('home')}}#benefits" class="links_rodape" style="margin-right: 0px; font-weight: bold;">VANTAGENS</a></li>
							<li><a href="{{route('home')}}#simulation" class="links_rodape" style="margin-right: 0px; font-weight: bold;">SIMULAÇÃO</a></li>
							<li><a href="{{route('invest')}}" class="links_rodape {{$page == 'invest'?'active':''}}" style="margin-right: 0px; font-weight: bold;">INVISTA</a></li>
							<li><a href="{{route('login')}}" class="links_rodape" style="margin-right: 0px; font-weight: bold;"> <span class="button_nav_2">ACESSE</span></a></li>
