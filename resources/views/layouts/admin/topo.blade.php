		...
		<div class="topo-default-div">
			<div class="topo-default-imagem"> 
			  ...
			  <div class="fonte_nome_e_empresa">
				<div class="fonte_nome_e_empresa">{{isset(Auth::user()->name) ? Auth::user()->name : 'USUARIO'}}</div>
				<div class="kind">{{isset(Auth::user()->tipo) ? Auth::user()->tipo : 'USUARIO'}}</div>
			  </div>
			</div>
			<div class="topo-default-menus">
				<div class="{{ Request::is('admin/index') ? 'active' : (Request::is('admin/index/filtro') ? 'active' : 'inactive') }}">
					<a href="{{route('admin.index')}}" target="_self">
						<i class="las la-window-maximize icones"></i>
						<span class="posicao_fonte">Dashboard</span>
					</a>
				</div>
				<div class="{{ Request::is('admin/clientes') ? 'active' : (Request::is('admin/clientes/filter') ? 'active' : 'inactive') }}">
					<a href="{{route('admin.clientes')}}" target="_self">
						<i class="las la-briefcase icones"></i>
						<span class="posicao_fonte">Clientes</span>
					</a>
				</div>
				<div class="{{ Request::is('admin/borderos') ? 'active' : (Request::is('admin/solicitacoes/filter') ? 'active' : 'inactive') }}">
					<a href="{{route('admin.solicitacoes')}}" target="_self">
						<i class="las la-list-alt icones"></i>
						<span class="posicao_fonte">Borderôs</span>
						@if(Session::has('pendentes'))
						<span class="notifications">{{Session::get('pendentes')}}</span>
						@endif
					</a>
				</div>
				<div class="{{ Request::is('admin/perfil') ? 'active' : 'inactive' }}">
					<a href="{{route('admin.perfil')}}" target="_self">
