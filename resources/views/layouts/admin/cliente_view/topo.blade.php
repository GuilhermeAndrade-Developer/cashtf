		...
		<div class="topo-default-div">
			<div class="topo-default-imagem"> 
			  <div class="fonte_nome_e_empresa">
					<div class="kind">CLIENTE</div>
					<div class="fonte_nome_e_empresa">{{isset($empresa) ? $empresa->OfficialName : ''}}</div>
			  </div>
			</div>
			<div class="topo-default-menus">
				<div class="{{ Request::is('admin/cliente/'.$id.'/solicitacoes') ? 'active' : (Request::is('admin/cliente/'.$id.'/solicitacoes/filter') ? 'active' : 'inactive')}}">
					<a href="{{route('admin.cliente.solicitacoes',$id)}}" target="_self">
						<i class="las la-list-alt icones"></i>
						<span class="posicao_fonte">Borderôs</span>
					</a>
				</div>
				<div class="{{ Request::is('admin/clientes/'.$id) ? 'active' : 'inactive' }}">
					<a href="{{route('admin.clientes.view', $id)}}" target="_self">
						<i class="fa fa-cog icones"></i>
						<span class="posicao_fonte">Perfil Cliente</span>  
					</a>
				</div>
	...
	<!-- Modal -->
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				$('#tarifa_bordero').mask('#.##0,00', {reverse: true});
			});
			$('.data_padrao').mask('00/00/0000');
