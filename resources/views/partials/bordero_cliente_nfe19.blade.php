...
<div class="div_geral_socio_procurador">
    ...
    <div class="container-fluid">
        ...
        <div class="div_pai_analisar_fundo_vinho_selecionada mt10 ">
        ...
        <div class="div_pai_solicitar_fundo_vinho_selecionada">
            <div class="flex1_text_center">
            </div>
            <div class="flex1_text_center">
            </div>
            ...
            <div class="flex1_text_center">
                <span><b>TOTAL NÃO APROVADO</b></span>
            </div>
            <div class="flex1_text_center">
                <span><b>JUROS</b></span>
            </div>
        </div>
        <div class="div_pai_analisar_fundo_vinho_claro_selecionada">
            <div class="flex1_text_center">
            </div>
            <div class="flex1_text_center">
            </div>
