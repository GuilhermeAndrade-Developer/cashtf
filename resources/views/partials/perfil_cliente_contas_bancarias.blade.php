...
<div class="form_socio_procurador">
    <div id="divContas" class="flexpai mt20" ng-repeat="c in contas">
        <div style="width: 400px">
            ...
            <select id="clientebanco" ng-model="c.banco">
        ...
        <div style="width: 160px">
            <label for="clienteagencia">AGÊNCIA (SEM DÍGITO)</label>
            <input type="text" id="clienteagencia" ng-model="c.agencia" placeholder="Agência...">
        </div>
        <div class="ph10"></div>
        <div style="width: 170px">
            <label for="clienteconta">CONTA</label>
            <input type="text" id="clienteconta" ng-model="c.conta" placeholder="Conta...">
        </div>
        <div class="ph10"></div>
        <div style="width: 50px">
            <label for="clientedigito">DIGITO</label>
            <input type="text" id="clientedigito" ng-model="c.digito" placeholder="Digito...">
        </div>
        <div class="ph10"></div>
...
<div class="mt40">
    <button type="button" class="btn btn-primary botaoadicionarsocio" ng-click="appendClonedConta()" style="width: auto;">ADICIONAR OUTRA CONTA</button>
</div>
