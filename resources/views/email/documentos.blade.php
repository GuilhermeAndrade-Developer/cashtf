                                ...
                                <tr>
                                    <td style="padding: 100px 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #6A6A6A;">
                                        <h1 style="text-align:center; margin: 0 0 10px 0; font-family: sans-serif; font-size: 21px; line-height: 26px; color: #6A6A6A; font-weight: normal;">
                                           ...
                                           Para a conclusão do seu cadastro, você precisará enviar os seguintes documentos:<br>
                                           - CONTRATO SOCIAL consolidado ou contrato social e alterações<br>
                                           - FATURAMENTO DOS ÚLTIMOS 12 MESES assinado pelo Contador e Sócio Administrador<br>
                                           - CNH (CARTEIRA de MOTORISTA) OU IDENTIDADE E CPF dos sócios<br>
