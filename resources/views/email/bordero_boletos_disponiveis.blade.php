    ...
    <![endif]-->
        ...
        <style>
            a.access {
                border: 0;
                border-radius: 0;
                padding: 0.87em 5.43em;
                cursor: pointer;
                font-weight: bolder;

                color: white;
                background-color: #f01971;
                }
        </style>
                    ...
                    <tr>
                        <td style="background-color: #ffffff;">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td style="padding: 13px 20px 55px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #6A6A6A;">
                                        <h1 style="text-align:center; margin: 0 0 55px 0; font-family: sans-serif; font-size: 21px; line-height: 26px; color: #6A6A6A; font-weight: normal;">
                                            Olá {{$data['name']}}, <br><br>
                                            Os boletos já estão disponíveis no <br>
                                            seu portal da cashTF.
                                        </h1>
                                    </td>
                                    <td class="button-td button-td-primary" style="border-radius: 4px; background: #f11070;">
                                        <a class="access" href="{{route('cliente.index')}}">ACESSAR</a>
                                    </td>
                                </tr>
                                <tr>
